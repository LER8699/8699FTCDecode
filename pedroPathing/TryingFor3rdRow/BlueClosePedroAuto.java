...
@Autonomous(name = "BLUE: Close Autonomous", group = "Autonomous", preselectTeleOp="DriveAndShooter")
@Configurable
public class BlueClosePedroAuto extends OpMode {
    ...
    public void autonomousPathUpdate() {
        ...
        switch (pathState) {
            ...
            case 7:
                if (!follower.isBusy()) {
                    if (alignWithLimelight(tx, foundTag) || pathTimer.getElapsedTimeSeconds() > 3.5) {
                        stopDrive();
                        intake.setPower(0);
    ...
    public static class Paths {
        ...
        public Paths(Follower follower) {
            ...
            Leave = follower.pathBuilder().addPath(
                            new BezierLine(
                                    new Pose(51.000, 92.000),

                                    new Pose(29.159, 70.206)
                            )
