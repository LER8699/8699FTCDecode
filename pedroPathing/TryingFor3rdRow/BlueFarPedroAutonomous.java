...
@Autonomous(name = "BLUE: PedroPathing Far Autonomous", group = "Autonomous", preselectTeleOp="DriveAndShooter")
@Configurable
    ...
    public void autonomousPathUpdate() {
        ...
        switch (pathState) {
            ...
            case 1: // Shoot Initial Sequence
                if (!follower.isBusy()) {
                    if (alignWithLimelight(tx, foundTag) || pathTimer.getElapsedTimeSeconds() > 3.0) {
                        stopDrive();
            ...
            case 4: // Shoot 2 Sequence
                if (!follower.isBusy()) {
                    if (alignWithLimelight(tx, foundTag) || pathTimer.getElapsedTimeSeconds() > 5.5) {
                        stopDrive();
                        intake.setPower(0);
